...
loraweightlists = [[
    'models/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_full/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_full_last.pt'
], [
    'models/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_innoxattn/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_innoxattn_last.pt'
], [
    'models/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_noxattn-hspace/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_noxattn-hspace_last.pt'
], [
    'models/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_noxattn-hspace-last/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_noxattn-hspace-last_last.pt'
], [
    'models/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_selfattn/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_selfattn_last.pt'
], [
    'models/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_xattn/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_xattn_last.pt'
], [
    'models/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_xattn-strict/bear_plushiexl_left_column_learn_Q_Linear_and_Conv2_alpha1.0_rank16_xattn-strict_last.pt'
]]
                ...
                for lora_weight in lora_weights:
                    ...
                    for idx, image in enumerate(image_list):
                        for i in range(len(scales)):
                            save_path = os.path.join('different_subset_generate', f'image_{seeds[idx]}_prompt_{idprompt}_model_{train_method}.png')
